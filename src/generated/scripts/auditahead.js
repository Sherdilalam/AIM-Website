...
window.addEventListener('load',function(){
  ...
  var PT={".prod-hero .h1": {"en": "Intelligent multi-agent audit automation.", "fr": "Automatisation d’audit intelligente multi-agents."}, ".prod-hero .sub": {"en": "AIM’s purpose-built audit automation platform for healthcare and compliance-intensive industries. Powered by a four-agent LangGraph architecture on IBM watsonx Orchestrate - compressing audit cycles from days to minutes.", "fr": "La plateforme d’automatisation d’audit d’AIM pour les industries de santé et de conformité. Propulsée par une architecture LangGraph à quatre agents - comprimant les cycles d’audit de jours à minutes."}, ".prod-hero .btn-primary": {"en": "Connect with us →", "fr": "Connectez-nous →"}, ".prod-hero .btn-ghost": {"en": "See how it works", "fr": "Découvrir le fonctionnement"}, ".ft-tab:nth-child(1)": {"en": "Consent compliance", "fr": "Conformité du consentement"}, ".ft-tab:nth-child(2)": {"en": "Claims analysis", "fr": "Analyse des réclamations"}, ".ft-tab:nth-child(3)": {"en": "Forensic review", "fr": "Examen forensique"}, ".ft-tab:nth-child(4)": {"en": "Audit attestation", "fr": "Attestation d’audit"}, ".step:nth-child(1) h3": {"en": "HMAC-SHA256 signing", "fr": "Signature HMAC-SHA256"}, ".step:nth-child(2) h3": {"en": "Append-only evidence ledger", "fr": "Registre de preuves en ajout seulement"}, ".step:nth-child(3) h3": {"en": "12-point end-to-end validation", "fr": "Validation bout en bout en 12 points"}, ".cta h2": {"en": "Replace reactive audits with continuous trust.", "fr": "Remplacez les audits réactifs par une confiance continue."}, ".cta p": {"en": "See AuditAhead in action - from batch intake to board-ready attestation in under 30 seconds.", "fr": "Voyez AuditAhead en action - de l’entrée de lot à l’attestation en moins de 30 secondes."}, ".cta .btn-primary": {"en": "Connect with us →", "fr": "Connectez-nous →"}};
