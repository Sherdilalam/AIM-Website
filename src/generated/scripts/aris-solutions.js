...
window.addEventListener('load',function(){
  ...
  var TR={"en": {"lead": "ARIS is the standard for business process modeling and management. AIM uses ARIS to map, analyze, and improve your processes - giving leadership a clear, governed view of how the business really works.", "cta1": "Talk to our team", "cta2": "See what we do", "cap.eb": "What ARIS unlocks", "cap.h2": "One platform, end to end.", "off.h2": "How AIM delivers ARIS", "end.eb": "Let's talk", "end.h2": "Get more from ARIS.", "end.p": "AIM uses ARIS to give you a governed, accurate picture of your processes - and a path to improve them.", "end.b2": "Strategy & Advisory"}, "fr": {"lead": "ARIS est la référence en modélisation et gestion des processus. AIM utilise ARIS pour cartographier, analyser et améliorer vos processus.", "cta1": "Parler à notre équipe", "cta2": "Voir nos services", "cap.eb": "Ce que ARIS permet", "cap.h2": "Une plateforme, de bout en bout.", "off.h2": "How AIM delivers ARIS", "end.eb": "Parlons-en", "end.h2": "Tirez plus d’ARIS.", "end.p": "AIM uses ARIS to give you a governed, accurate picture of your processes - and a path to improve them.", "end.b2": "Strategy & Advisory"}};
