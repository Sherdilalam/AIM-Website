...
window.addEventListener('load',function(){
  ...
  var TR={"en": {"eb": "Rehosting, Refactoring & Replatforming", "h1": "Move fast. Break nothing.", "lead": "Not every workload deserves the same journey. AIM applies the right R to each application - rapid rehosting where speed matters, replatforming for quick wins, and refactoring where cloud-native value justifies the investment.", "cta1": "Connect with us", "cta2": "See our approach", "s1": "Disposition framework", "s2": "Migration factory", "s3": "Every cutover", "pill.eb": "What we deliver", "pill.h2": "The right R for every workload.", "p1": "Rehosting (Lift & Shift)", "p2": "Replatforming", "p3": "Refactoring", "why.eb": "Why AIM", "why.h2": "Speed and safety, engineered together.", "step.eb": "Our approach", "step.h2": "From datacenter to cloud, wave by wave.", "end.eb": "Get started", "end.h2": "Let's move your workloads.", "end.p": "Whether the driver is a datacenter exit, an expiring contract, or a modernization mandate - AIM gets workloads to the cloud fast, safely, and with the economics understood upfront.", "end.b2": "Back to Cloud & Infrastructure"}, "fr": {"eb": "Réhébergement, refactorisation et replateformage", "h1": "Avancez vite. Sans rien casser.", "lead": "Le bon « R » pour chaque application : réhébergement rapide, replateformage ou refactorisation selon la valeur.", "cta1": "Contactez-nous", "cta2": "Notre approche", "pill.eb": "Ce que nous livrons", "pill.h2": "The right R for every workload.", "p1": "Réhébergement", "p2": "Replateformage", "p3": "Refactorisation", "why.eb": "Pourquoi AIM", "why.h2": "Vitesse et sécurité, conçues ensemble.", "step.eb": "Notre approche", "step.h2": "From datacenter to cloud, wave by wave.", "end.eb": "Commencer", "end.h2": "Déplaçons vos charges de travail.", "end.p": "Whether the driver is a datacenter exit, an expiring contract, or a modernization mandate - AIM gets workloads to the cloud fast, safely, and with the economics understood upfront.", "end.b2": "Retour à Infonuagique et infrastructure"}};
  ...
  if(window.gsap&&window.ScrollTrigger&&!rm){gsap.registerPlugin(ScrollTrigger);
    ...
    d.querySelectorAll('.sa-fit').forEach(function(f,i){gsap.from(f,{opacity:0,y:16,duration:.4,delay:(i%2)*.08,ease:'power3.out',scrollTrigger:{trigger:f,start:'top 92%',once:true}});});
  ...
  bind(d.querySelectorAll('.sa-pillar,.sa-fit,.sa-why-card,.sa-step,a'));
