...
window.addEventListener('load',function(){
  ...
  var MAP=[
    ...
    ['cl.eb','.sec:nth-child(7) .eyebrow'],['cl.h2','.sec:nth-child(7) .heading'],
    ['c1.h','.sec:nth-child(7) .vs-comp:nth-child(1) h3'],['c1.p','.sec:nth-child(7) .vs-comp:nth-child(1) p'],
    ['c2.h','.sec:nth-child(7) .vs-comp:nth-child(2) h3'],['c2.p','.sec:nth-child(7) .vs-comp:nth-child(2) p'],
    ['c3.h','.sec:nth-child(7) .vs-comp:nth-child(3) h3'],['c3.p','.sec:nth-child(7) .vs-comp:nth-child(3) p'],
    ['c4.h','.sec:nth-child(7) .vs-comp:nth-child(4) h3'],['c4.p','.sec:nth-child(7) .vs-comp:nth-child(4) p'],
