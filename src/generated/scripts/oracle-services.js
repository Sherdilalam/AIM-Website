...
window.addEventListener('load',function(){
  ...
  var TR={"en": {"lead": "Oracle runs mission-critical systems for enterprises worldwide. AIM helps you modernize, integrate, and optimize Oracle databases and applications - and move to Oracle Cloud where it makes sense.", "cta1": "Talk to our team", "cta2": "See what we do", "cap.eb": "What Oracle unlocks", "cap.h2": "One platform, end to end.", "off.h2": "How AIM delivers on Oracle", "end.eb": "Let's talk", "end.h2": "Get more from Oracle.", "end.p": "From database tuning to OCI migration, AIM keeps your Oracle systems fast, reliable, and modern.", "end.b2": "Explore App Development"}, "fr": {"lead": "Oracle fait tourner des systèmes critiques. AIM modernise, intègre et optimise vos bases et applications Oracle, et migre vers Oracle Cloud au besoin.", "cta1": "Parler à notre équipe", "cta2": "Voir nos services", "cap.eb": "Ce que Oracle permet", "cap.h2": "Une plateforme, de bout en bout.", "off.h2": "How AIM delivers on Oracle", "end.eb": "Parlons-en", "end.h2": "Tirez plus d’Oracle.", "end.p": "From database tuning to OCI migration, AIM keeps your Oracle systems fast, reliable, and modern.", "end.b2": "Explore App Development"}};
