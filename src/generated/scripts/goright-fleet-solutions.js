...
window.addEventListener('load',function(){
  ...
  var TR={"en": {"lead": "GoRight Fleet Solutions Inc. brings intelligent automation and data capabilities to the enterprise. AIM implements and integrates GoRight to help you extract, process, and act on information faster and more accurately.", "cta1": "Talk to our team", "cta2": "See what we do", "cap.eb": "What GoRight Fleet Solutions Inc. unlocks", "cap.h2": "One platform, end to end.", "off.h2": "How AIM delivers GoRight Fleet Solutions Inc.", "end.eb": "Let's talk", "end.h2": "Get more from GoRight Fleet Solutions Inc.", "end.p": "AIM implements and integrates GoRight so you can capture, process, and act on information intelligently.", "end.b2": "Explore Innovation"}, "fr": {"lead": "GoRight Fleet Solutions Inc. apporte automatisation intelligente et capacités de données à l’entreprise. AIM implémente et intègre GoRight pour extraire et traiter l’information plus vite.", "cta1": "Parler à notre équipe", "cta2": "Voir nos services", "cap.eb": "Ce que GoRight Fleet Solutions Inc. permet", "cap.h2": "Une plateforme, de bout en bout.", "off.h2": "How AIM delivers GoRight Fleet Solutions Inc.", "end.eb": "Parlons-en", "end.h2": "Tirez plus de GoRight Fleet Solutions Inc.", "end.p": "AIM implements and integrates GoRight so you can capture, process, and act on information intelligently.", "end.b2": "Explore Innovation"}};
