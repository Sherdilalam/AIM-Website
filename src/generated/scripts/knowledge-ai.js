...
window.addEventListener('load',function(){
  ...
  var MAP=[['eb','.ka-hero .eyebrow'],['h1','.ka-hero .h1'],['lead','.ka-hero .lead'],['cta1','.ka-hero .btn-primary'],['cta2','.ka-hero .btn-ghost'],['prob.eb','#ka-problem .eyebrow'],['prob.h2','#ka-problem .heading'],['how.eb','#ka-how-head .eyebrow'],['how.h2','#ka-how-head .heading'],['s1.h','.ka-step:nth-child(1) h3'],['s2.h','.ka-step:nth-child(2) h3'],['s3.h','.ka-step:nth-child(3) h3'],['cap.eb','#ka-cap-head .eyebrow'],['cap.h2','#ka-cap-head .heading'],['c1.h','.ka-cap:nth-child(1) h3'],['c2.h','.ka-cap:nth-child(2) h3'],['c3.h','.ka-cap:nth-child(3) h3'],['c4.h','.ka-cap:nth-child(4) h3'],['c5.h','.ka-cap:nth-child(5) h3'],['c6.h','.ka-cap:nth-child(6) h3'],['int.eb','#ka-int-head .eyebrow'],['int.h2','#ka-int-head .heading'],['end.eb','.sa-cta .eyebrow'],['end.h2','.sa-cta .heading'],['end.p','.sa-cta p'],['end.btn1','.sa-cta .btn-primary'],['end.btn2','.sa-cta .btn-ghost']];
