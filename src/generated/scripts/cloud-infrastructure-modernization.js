...
window.addEventListener('load',function(){
  ...
  var MAP=[['eb','.cl-hero .eyebrow'],['lead','.cl-hero .lead'],['cta1','.cl-hero .btn-primary'],['cta2','.cl-hero .btn-ghost'],['tab.eb','#cl-tab-head .eyebrow'],['tab.h2','#cl-tab-head .heading'],['j.eb','#cl-j-head .eyebrow'],['j.h2','#cl-j-head .heading'],['out.eb','#cl-out-head .eyebrow'],['out.h2','#cl-out-head .heading'],['sub.eb','#cl-sub-head .eyebrow'],['sub.h2','#cl-sub-head .heading'],['end.eb','.cl-cta .eyebrow'],['end.h2','.cl-cta .heading'],['end.p','.cl-cta p'],['end.b2','.cl-cta .btn-ghost']];
  ...
  if(!haveGSAP||rm){
    ...
    ['.cl-out','.cl-sub','.cl-tabs','.cl-cta','.cl-layer'].forEach(function(sel){
  ...
  if(haveGSAP&&!rm){gsap.registerPlugin(ScrollTrigger);
    ...
    gsap.fromTo('.cl-cta',{opacity:0,y:30,scale:.98},{opacity:1,y:0,scale:1,duration:.7,ease:'power3.out',scrollTrigger:{trigger:'.cl-cta',start:'top 95%',once:true}});
  }
