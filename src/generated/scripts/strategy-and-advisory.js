...
window.addEventListener('load',function(){
  ...
  var MAP=[['eb','.st-hero .eyebrow'],['h1sub','.st-hero .sub-h'],['lead','.st-hero .lead'],['cta1','.st-hero .btn-primary'],['cta2','.st-hero .btn-ghost'],['pill.eb','#st-pill-head .eyebrow'],['pill.h2','#st-pill-head .heading'],['out.eb','#st-out-head .eyebrow'],['out.h2','#st-out-head .heading'],['j.eb','#st-j-head .eyebrow'],['j.h2','#st-j-head .heading'],['sub.eb','#st-sub-head .eyebrow'],['sub.h2','#st-sub-head .heading'],['end.eb','.st-cta .eyebrow'],['end.h2','.st-cta .heading'],['end.p','.st-cta p']];
  ...
  if(window.gsap&&window.ScrollTrigger&&!rm){gsap.registerPlugin(ScrollTrigger);
    ...
    gsap.from('.st-cta',{opacity:0,y:30,scale:.98,duration:.7,ease:'power3.out',scrollTrigger:{trigger:'.st-cta',start:'top 85%',once:true}});
  }
