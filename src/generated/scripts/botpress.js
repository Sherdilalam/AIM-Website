...
window.addEventListener('load',function(){
  ...
  var TR={"en": {"lead": "Botpress is a leading platform for building conversational AI. AIM designs, builds, and deploys Botpress chatbots and AI agents that automate support, answer accurately, and integrate with your systems.", "cta1": "Talk to our team", "cta2": "See what we do", "cap.eb": "What Botpress unlocks", "cap.h2": "One platform, end to end.", "off.h2": "How AIM delivers Botpress", "end.eb": "Let's talk", "end.h2": "Get more from Botpress.", "end.p": "AIM builds Botpress agents that resolve real questions, integrate with your systems, and stay accurate.", "end.b2": "Generative AI Consulting"}, "fr": {"lead": "Botpress est une plateforme de premier plan pour l’IA conversationnelle. AIM conçoit, bâtit et déploie des agents Botpress précis et intégrés.", "cta1": "Parler à notre équipe", "cta2": "Voir nos services", "cap.eb": "Ce que Botpress permet", "cap.h2": "Une plateforme, de bout en bout.", "off.h2": "How AIM delivers Botpress", "end.eb": "Parlons-en", "end.h2": "Tirez plus de Botpress.", "end.p": "AIM builds Botpress agents that resolve real questions, integrate with your systems, and stay accurate.", "end.b2": "Generative AI Consulting"}};
