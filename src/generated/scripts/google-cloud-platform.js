...
window.addEventListener('load',function(){
  ...
  var TR={"en": {"lead": "Google Cloud leads on data, analytics, and AI. AIM helps you harness it - designing, migrating, and managing GCP environments that turn Google’s strengths into secure, scalable business outcomes.", "cta1": "Talk to our team", "cta2": "See what we do", "cap.eb": "What Google Cloud unlocks", "cap.h2": "One platform, end to end.", "off.h2": "How AIM delivers on GCP", "end.eb": "Let's talk", "end.h2": "Get more from Google Cloud.", "end.p": "From BigQuery analytics to Vertex AI, AIM helps you turn Google Cloud into real outcomes.", "end.b2": "Explore Cloud services"}, "fr": {"lead": "Google Cloud excelle en données, analytique et IA. AIM conçoit, migre et gère des environnements GCP sécurisés et évolutifs.", "cta1": "Parler à notre équipe", "cta2": "Voir nos services", "cap.eb": "Ce que Google Cloud permet", "cap.h2": "Une plateforme, de bout en bout.", "off.h2": "How AIM delivers on GCP", "end.eb": "Parlons-en", "end.h2": "Tirez plus de Google Cloud.", "end.p": "From BigQuery analytics to Vertex AI, AIM helps you turn Google Cloud into real outcomes.", "end.b2": "Explore Cloud services"}};
