...
window.addEventListener('load',function(){
  ...
  var MAP=[['eb','.su-hero .eyebrow'],['h1','.su-hero .h1'],['sub','.su-hero .sub'],['cta1','.su-hero .btn-primary'],['cta2','.su-hero .btn-ghost'],['ch.eb','#su-ch-head .eyebrow'],['ch.h2','#su-ch-head .heading'],['c1.h','.su-ch:nth-child(1) h3'],['c1.p','.su-ch:nth-child(1) p'],['c2.h','.su-ch:nth-child(2) h3'],['c2.p','.su-ch:nth-child(2) p'],['c3.h','.su-ch:nth-child(3) h3'],['c3.p','.su-ch:nth-child(3) p'],['cat.eb','#su-cat-head .eyebrow'],['cat.h2','#su-cat-head .heading'],['s1.h','.su-cat:nth-child(1) h3'],['s1.p','.su-cat:nth-child(1) p'],['s2.h','.su-cat:nth-child(2) h3'],['s2.p','.su-cat:nth-child(2) p'],['s3.h','.su-cat:nth-child(3) h3'],['s3.p','.su-cat:nth-child(3) p'],['s4.h','.su-cat:nth-child(4) h3'],['s4.p','.su-cat:nth-child(4) p'],['s5.h','.su-cat:nth-child(5) h3'],['s5.p','.su-cat:nth-child(5) p'],['s6.h','.su-cat:nth-child(6) h3'],['s6.p','.su-cat:nth-child(6) p'],['prod.eb','#su-prod-head .eyebrow'],['prod.h2','#su-prod-head .heading'],['hrs.h','.su-box:nth-child(1) h3'],['nc.h','.su-box:nth-child(2) h3'],['reach.eb','#su-reach-head .eyebrow'],['reach.h2','#su-reach-head .heading'],['e.h','.su-cc:nth-child(1) h4'],['ph.h','.su-cc:nth-child(2) h4'],['po.h','.su-cc:nth-child(3) h4'],['cta.eb','.sa-cta .eyebrow'],['cta.h2','.sa-cta .heading'],['cta.p','.sa-cta p'],['cta.btn1','.sa-cta .btn-primary'],['cta.btn2','.sa-cta .btn-ghost']];
  function translate(){
  ...
  if(window.gsap&&window.ScrollTrigger&&!rm){
    ...
    /* CTA */
    gsap.from('.sa-cta .wrap > *',{opacity:0,y:24,stagger:.1,duration:.7,ease:'power3.out',scrollTrigger:{trigger:'.sa-cta',start:'top 80%',once:true}});
  }
