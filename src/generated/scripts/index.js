...
window.addEventListener('load', function(){
  ...
  renderCases();
  /* services explorer */
  var SERV_SLUGS=['/strategy-and-advisory','/cloud-infrastructure-modernization','/application-development-integration-services','/ai-business-intelligence-solutions','/quality-assurance-testing','/managed-it-application-services','/staff-augmentation-support','/innovation-emerging-technologies'];
