...
window.addEventListener('load',function(){
  ...
  var TR={"en": {"lead": "Jasper.AI brings generative AI to marketing and content at scale. AIM helps you adopt Jasper responsibly - integrating it into your workflows and brand guardrails so teams create faster without losing control.", "cta1": "Talk to our team", "cta2": "See what we do", "cap.eb": "What Jasper.AI unlocks", "cap.h2": "One platform, end to end.", "off.h2": "How AIM delivers Jasper.AI", "end.eb": "Let's talk", "end.h2": "Get more from Jasper.AI.", "end.p": "AIM helps you adopt Jasper.AI with the guardrails and integration that make generative content safe and scalable.", "end.b2": "Generative AI Consulting"}, "fr": {"lead": "Jasper.AI apporte l’IA générative au marketing et au contenu à grande échelle. AIM vous aide à l’adopter de façon responsable et intégrée.", "cta1": "Parler à notre équipe", "cta2": "Voir nos services", "cap.eb": "Ce que Jasper.AI permet", "cap.h2": "Une plateforme, de bout en bout.", "off.h2": "How AIM delivers Jasper.AI", "end.eb": "Parlons-en", "end.h2": "Tirez plus de Jasper.AI.", "end.p": "AIM helps you adopt Jasper.AI with the guardrails and integration that make generative content safe and scalable.", "end.b2": "Generative AI Consulting"}};
