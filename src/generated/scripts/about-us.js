...
window.addEventListener('load', function(){
  ...
  var T={
    ...
    'ab.p3':{en:'Architecture-First',fr:'Sécurité d’abord'},
    ...
    'ab.edge.cta':{en:'Start a conversation →',fr:'Démarrer une conversation →'},
