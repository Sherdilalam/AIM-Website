...
window.addEventListener('load',function(){
  ...
  var TR={"en": {"lead": "ServiceNow turns fragmented processes into automated digital workflows. AIM deploys, configures, and manages ServiceNow across ITSM, ITOM, and beyond - so work flows and your teams move faster.", "cta1": "Talk to our team", "cta2": "See what we do", "cap.eb": "What ServiceNow unlocks", "cap.h2": "One platform, end to end.", "off.h2": "How AIM delivers ServiceNow", "end.eb": "Let's talk", "end.h2": "Get more from ServiceNow.", "end.p": "From first module to a managed platform, AIM makes ServiceNow the backbone of how work gets done.", "end.b2": "ServiceNow services"}, "fr": {"lead": "ServiceNow transforme des processus fragmentés en flux numériques automatisés. AIM déploie, configure et gère ServiceNow (ITSM, ITOM et plus).", "cta1": "Parler à notre équipe", "cta2": "Voir nos services", "cap.eb": "Ce que ServiceNow permet", "cap.h2": "Une plateforme, de bout en bout.", "off.h2": "How AIM delivers ServiceNow", "end.eb": "Parlons-en", "end.h2": "Tirez plus de ServiceNow.", "end.p": "From first module to a managed platform, AIM makes ServiceNow the backbone of how work gets done.", "end.b2": "ServiceNow services"}};
