...
window.addEventListener('load',function(){
  ...
  var TR={"en": {"lead": "Enterprises run on integration. AIM uses webMethods to connect applications, data, and partners - building reliable, governed integration and API layers that keep the business flowing.", "cta1": "Talk to our team", "cta2": "See what we do", "cap.eb": "What webMethods unlocks", "cap.h2": "One platform, end to end.", "off.h2": "How AIM delivers webMethods", "end.eb": "Let's talk", "end.h2": "Get more from webMethods.", "end.p": "AIM builds and runs webMethods integration so your applications, data, and partners stay connected.", "end.b2": "API services"}, "fr": {"lead": "Les entreprises reposent sur l’intégration. AIM utilise webMethods pour connecter applications, données et partenaires de façon fiable et gouvernée.", "cta1": "Parler à notre équipe", "cta2": "Voir nos services", "cap.eb": "Ce que webMethods permet", "cap.h2": "Une plateforme, de bout en bout.", "off.h2": "How AIM delivers webMethods", "end.eb": "Parlons-en", "end.h2": "Tirez plus de webMethods.", "end.p": "AIM builds and runs webMethods integration so your applications, data, and partners stay connected.", "end.b2": "API services"}};
