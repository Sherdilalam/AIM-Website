...
// The contact form itself is a real React component (src/components/ContactForm.jsx),
// mounted via a portal into the #ctFormMount placeholder this page's content
// carries -- see that file and api/contact/index.js for the submit flow. The
// Power Automate URL lives only in the Azure Functions API's CONTACT_FLOW_URL
